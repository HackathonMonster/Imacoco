...
public class BluetoothChatService {
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        bundle.putString(AppConfig.DEVICE_NAME, device.getName());
        msg.setData(bundle);
     ...
     * @see com.zeroone_creative.basicapplication.controller.provider.BluetoothChatService.ConnectedThread#write(byte[])
     */
    ...
    private class ConnectedThread extends Thread {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(AppConfig.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
